...
@section('content')
    ...
    <div style="color: white">
        ...
        <p>
            ...
            de caracter interno
            e externo como é natural, mas a empresa sempre procurou garantir o abastecimento de água aos seus
            clientes-sua
        ...
        <p>
            É em nome da equipa que reitera-se o compromisso de procurar trabalhar para melhorar a qualidade de vida de
            nossos clientes,
